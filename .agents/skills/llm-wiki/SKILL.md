...
- **文本** → 保存到 `raw/notes/`
- **小红书视频链接** → 下载视频保存到 `raw/videos/xiaohongshu/`
- **已有文件** → 直接读取
...
[下载视频到 raw/videos/xiaohongshu/2026-04-13-123456789.mp4]
[提取视频元数据和内容]
...
Agent: [创建 wiki/sources/2026-04-13-时间管理技巧.md]
[创建 wiki/concepts/时间管理.md - 重点展开新方法]
